...
class FavoriteAnimationComponent extends StatefulWidget {
  const FavoriteAnimationComponent({Key? key}) : super(key: key);

  @override
  _FavoriteAnimationComponentState createState() => _FavoriteAnimationComponentState();
}
                  ...
                  return Align(
                    ...
                    child: Opacity(
                      ...
                      child: SizedBox(
                        ...
                        child: Image.asset('images/favorite/fav_heart_waveeffect.png'),
                      ),
                    ),
                  );
                }),
