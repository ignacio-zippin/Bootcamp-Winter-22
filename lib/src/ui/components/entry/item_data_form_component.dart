...
import 'package:playground_app/src/ui/components/entry/checkbox_component.dart';
import 'package:playground_app/src/ui/components/entry/draw_signature_component.dart';
...
class _ItemDataFormComponentState extends State<ItemDataFormComponent> {
  ...
  _content() {
    switch (widget.type) {
      ...
      case ItemDataFormType.signature:
        return _signature();
  ...
  _signature() {
    return Column(
      children: [
        SizedBox(
          height: !widget.label.isNullOrEmpty() ? 15 : 0,
        ),
        DrawSignature(
          cleanLabel: 'Limpiar',
